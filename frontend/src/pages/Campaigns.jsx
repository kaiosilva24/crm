...
export default function Campaigns() {
    ...
    const [form, setForm] = useState({ name: '', description: '', mirror_campaign_id: '' });
                        ...
                        <form onSubmit={handleSubmit} autoComplete="off">
                            ...
                            <div className="form-group">
                                ...
                                <select
                                    ...
                                    value={form.mirror_campaign_id || ''}
                                    onChange={e => setForm({ ...form, mirror_campaign_id: e.target.value || null })}
                                >
